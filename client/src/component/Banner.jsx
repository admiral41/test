    ...
    <div className="flex justify-center items-center max-w-7xl mx-auto pt-5 max-sm:flex-col max-sm:px-5 max-sm:gap-y-5">
      ...
      <div className="flex flex-col gap-y-5">
        ...
        <p className="text-xl font-bold text-gray-600">
          Send your files and photos <span className="uppercase text-blue-500">securely</span> with EncryptShare <span className="uppercase text-blue-500">anytime</span> and <span className="uppercase text-blue-500">anywhere</span> in the world.
        </p>
