...
import { z } from "zod";
import { uploadFileApi } from "../Apis/Api";
...
const passwordSchema = z.string().min(5, "Password field must be valid length and value");
...
const UploadForm = () => {
    ...
    const onFileSelect = (file) => {
        ...
        if (!allowedExtensions.includes(fileExtension)) {
            ...
            setErrorMsg(`File type not allowed. Allowed types: ${allowedExtensions.join(", ")}`);
            return;
        }
    ...
    return (
        <div className="text-center">
            ...
            <p className="font-bold py-5 max-sm:text-sm">
                Note: Remember to copy your password and send it to the receiver. Because
